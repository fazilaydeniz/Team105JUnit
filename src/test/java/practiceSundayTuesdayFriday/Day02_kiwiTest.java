...
public class Day02_kiwiTest {
   ...
   @Test
    public void kiwiTest() throws InterruptedException {
       ...
       dilSecimi.click();
       WebElement selectWebEleman= driver.findElement(By.xpath("//select[@data-test='LanguageSelect']"));
       Select select=new Select(selectWebEleman);
       ...
       WebElement defaultCloseSity= driver.findElement(By.xpath("//div[@data-test='PlacePickerInputPlace-close']"));
       defaultCloseSity.click();
